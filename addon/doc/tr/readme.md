...
1. Eklenti kurulum dosyasını [Kişi Defteri](https://github.com/EdilbertoFonseca/contactBook/releases/download/v1.0/contactBook-2023.1.0.nvda-addon) indirin.
...
1. Telefon biçimlendirmesini kullanma, onay kutusu işaretli değil. alt+t.
Bu seçenek, telefon numarası biçimlendirmesini ekler veya kaldırır. şimdilik Brezilya için yalnızca biçimlendirme (+55) mevcuttur.
